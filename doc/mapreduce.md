...
基于以上的背景，go-zero框架中为我们提供了并发处理工具[MapReduce](github.com/shuguocloud/go-zero/blob/master/core/mr/mapreduce.go)，该工具开箱即用，不需要做什么初始化，我们通过下图看下使用MapReduce和没使用的耗时对比:
...
## 并发处理工具[MapReduce](github.com/shuguocloud/go-zero/tree/master/core/mr)
